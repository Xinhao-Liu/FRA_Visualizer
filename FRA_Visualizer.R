    ...
    sidebarPanel(
      ...
      conditionalPanel(
        ...
        sliderInput("train_length", 
                    ...
                    min = 0, max = 200, value = c(0, 200), step = 1),
      ...
      data() %>% 
        mutate(
          LEN_R = case_when(
            ...
            TotalConsist > 160 ~ ">160",
            TRUE ~ "NO DATA"
          ),
          LEN_R = fct_relevel(factor(LEN_R),c("<=70","71-80","81-90","91-100","101-110","111-120","121-130","131-140","141-150","151-160",">160"))
        ) %>% 
        group_by(LEN_R) %>%
