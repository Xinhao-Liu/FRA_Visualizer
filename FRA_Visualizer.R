...
server <- function(input, output) {
  ...
  observeEvent(input$Button1, {
    showModal(modalDialog("Current Visualizer contains FRA REA data from 1997-2023. Please contact Xinhao Liu (xinhaol2@illinois.edu) if you have
